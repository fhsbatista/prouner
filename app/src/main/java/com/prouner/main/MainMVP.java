...
public interface MainMVP {
    ...
    interface View {
        ...
        /**
         * This method is provided so that the view can be able to a UI element representing that the data is being loaded, a "Loading" text can be shown for instance.
         */
    ...
    interface Presenter{
         ...
         * @param optionText Contains the text of the option which the user has choosen.
         *                   <p>It will be used to compare
         *                   the user's answers with the correct answer so that the presenter can know wheter the user
         *                   has made the correct choose</p>
         */
